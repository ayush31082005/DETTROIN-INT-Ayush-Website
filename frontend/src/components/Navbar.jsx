            ...
            {!isMobile && (
              <ul className="hidden lg:flex items-center space-x-6 font-medium">
                ...
                <li ref={academicsRef} className="relative">
                  ...
                  {academicsOpen && (
                    <Dropdown>
                      <DropdownLink to="/pre-primary" label="🧸 Pre-Primary & Primary" />
                      <DropdownLink to="/secondary" label="🏫 Secondary (6th–12th)" />
                ...
                <li ref={departmentsRef} className="relative">
                  ...
                  {departmentsOpen && (
                    <Dropdown>
                      <DropdownLink to="/admission-enquiry" label="Admission Enquiry" />
                      <DropdownLink to="/admissions" label="Admission" />
                    </Dropdown>
                  )}
                </li>
